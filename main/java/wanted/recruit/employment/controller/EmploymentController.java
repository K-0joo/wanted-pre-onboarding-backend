package wanted.recruit.employment.controller;
...
import wanted.recruit.employment.service.EmploymentService;
...
public class EmploymentController {
    ...
    public ResponseEntity<EmploymentDto> add(@PathVariable Long companyId, @RequestBody EmploymentDto dto){
        // 서비스에 위임
